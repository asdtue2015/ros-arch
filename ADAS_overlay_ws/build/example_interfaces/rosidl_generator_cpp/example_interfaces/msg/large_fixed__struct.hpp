...
#ifndef EXAMPLE_INTERFACES__MSG__LARGE_FIXED__STRUCT_HPP_
#define EXAMPLE_INTERFACES__MSG__LARGE_FIXED__STRUCT_HPP_
...
struct LargeFixed_
{
  ...
  explicit LargeFixed_(const ContainerAllocator & _alloc)
  {
    (void)_alloc;
  }
  ...
  Type * set__data(
    const std::array<int32_t, 255> & _arg)
  {
    this->data = _arg;
    return this;
  }
...
#endif  // EXAMPLE_INTERFACES__MSG__LARGE_FIXED__STRUCT_HPP_
