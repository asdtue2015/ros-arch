...
{
  example_interfaces__srv__AddTwoInts_Request * msg = malloc(sizeof(example_interfaces__srv__AddTwoInts_Request));
  if (!msg) {
    return NULL;
  }
...
example_interfaces__srv__AddTwoInts_Request__Array__init(example_interfaces__srv__AddTwoInts_Request__Array * array, size_t size)
{
  ...
  if (size) {
    data = malloc(sizeof(example_interfaces__srv__AddTwoInts_Request) * size);
    if (!data) {
      return false;
    }
...
{
  example_interfaces__srv__AddTwoInts_Request__Array * array = malloc(sizeof(example_interfaces__srv__AddTwoInts_Request__Array));
  if (!array) {
    return NULL;
  }
