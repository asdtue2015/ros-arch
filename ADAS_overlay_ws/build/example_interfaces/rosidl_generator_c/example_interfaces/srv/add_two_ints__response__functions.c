...
{
  example_interfaces__srv__AddTwoInts_Response * msg = malloc(sizeof(example_interfaces__srv__AddTwoInts_Response));
  if (!msg) {
    return NULL;
  }
...
example_interfaces__srv__AddTwoInts_Response__Array__init(example_interfaces__srv__AddTwoInts_Response__Array * array, size_t size)
{
  ...
  if (size) {
    data = malloc(sizeof(example_interfaces__srv__AddTwoInts_Response) * size);
    if (!data) {
      return false;
    }
...
{
  example_interfaces__srv__AddTwoInts_Response__Array * array = malloc(sizeof(example_interfaces__srv__AddTwoInts_Response__Array));
  if (!array) {
    return NULL;
  }
